...
\restrict WqYg8d2xdd7gwjdIz2dK0FdgWS5AgfHjGi1LR2cW52cgLrSWeKz9dleQ2LL4TZS
...
SELECT json_build_object(
  ...
  'alias_coverage', json_build_object(
    ...
    'german_umlaut_foods', (SELECT COUNT(*)::int FROM nutrition.foods WHERE name_de ~ '[├ñ├╢├╝├ä├û├£├ƒ]'),
...
--
-- Name: food_search(text, text, text[], uuid, text, uuid, text, text, integer, integer); Type: FUNCTION; Schema: nutrition; Owner: postgres
--
...
ALTER FUNCTION nutrition.food_search(p_query text, p_normalized_query text, p_tokens text[], p_selected_food_id uuid, p_category_slug text, p_category_id uuid, p_tag_code text, p_sort text, p_limit integer, p_offset integer) OWNER TO postgres;

--
-- Name: preference_search_preview(text, text, text[], text[], text[], text[], text[], text[], text, integer, integer); Type: FUNCTION; Schema: nutrition; Owner: postgres
--

CREATE FUNCTION nutrition.preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer) RETURNS json
    LANGUAGE sql STABLE
    AS $$
...
ALTER FUNCTION nutrition.preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer) OWNER TO postgres;
...
CREATE FUNCTION nutrition.search_fold(t text) RETURNS text
    ...
    AS $$
  SELECT replace(replace(replace(replace(lower(coalesce(t, '')), '├ñ', 'ae'), '├╢', 'oe'), '├╝', 'ue'), '├ƒ', 'ss')
$$;
...
--
-- Name: FUNCTION food_search(p_query text, p_normalized_query text, p_tokens text[], p_selected_food_id uuid, p_category_slug text, p_category_id uuid, p_tag_code text, p_sort text, p_limit integer, p_offset integer); Type: ACL; Schema: nutrition; Owner: postgres
--
...
--
-- Name: FUNCTION preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer); Type: ACL; Schema: nutrition; Owner: postgres
--

REVOKE ALL ON FUNCTION nutrition.preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer) FROM PUBLIC;
GRANT ALL ON FUNCTION nutrition.preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer) TO authenticated;
GRANT ALL ON FUNCTION nutrition.preference_search_preview(p_query text, p_normalized_query text, p_tokens text[], p_excluded_category_slugs text[], p_liked_category_slugs text[], p_disliked_category_slugs text[], p_liked_tags text[], p_disliked_tags text[], p_sort text, p_limit integer, p_offset integer) TO service_role;
...
\unrestrict WqYg8d2xdd7gwjdIz2dK0FdgWS5AgfHjGi1LR2cW52cgLrSWeKz9dleQ2LL4TZS
