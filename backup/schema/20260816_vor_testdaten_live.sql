...
\restrict YTlCNn7xM1ujaiiFQjMyTTGfXB7FOp9sXVXKxCYhjFMDNmXQpGCqM31nAInm2A9
...
COMMENT ON SCHEMA goals IS 'Ziele und Zielwerte (GO-03 aufwaerts). Heute nur die Tagesziele; user_goals, goal_phases und die Modulbeitraege sind GO-07 aufwaerts.';
...
COMMENT ON FUNCTION nutrition.daily_reference_assessment(p_user_id uuid, p_entry_date date) IS 'C-47: Numerischer Vergleich von daily_summary mit nutrient_reference_values anhand public.profiles. Fuehrt reference_kind und reference_direction mit; keine Ampel, kein Score, keine Wortbewertung. C-54: Fuehrt nutrient_display_tier aus nutrient_defs mit, damit die Anzeige Haupt- und Nebenwerte ordnen kann. Bei *_missing > 0 bleibt reference_pct NULL, damit eine unvollstaendige Summe nicht als Deckung erscheint.';
...
\unrestrict YTlCNn7xM1ujaiiFQjMyTTGfXB7FOp9sXVXKxCYhjFMDNmXQpGCqM31nAInm2A9
