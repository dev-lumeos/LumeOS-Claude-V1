...
\restrict 5HQeBWVni2eiYWFPSei7Y4oCAzJEdKntzPtzZziNAvebF9O6RTNLk7H6HcKiWCv
...
--
-- Name: food_search(text, text, text[], uuid, text, uuid, text, text, integer, integer, text[], text[], boolean); Type: FUNCTION; Schema: nutrition; Owner: -
--

CREATE FUNCTION nutrition.food_search(p_query text, p_normalized_query text, p_tokens text[], p_selected_food_id uuid, p_category_slug text, p_category_id uuid, p_tag_code text, p_sort text, p_limit integer, p_offset integer, p_preparations text[] DEFAULT NULL::text[], p_groups text[] DEFAULT NULL::text[], p_basics_only boolean DEFAULT false) RETURNS json
    LANGUAGE sql STABLE
    AS $$
WITH params AS (
  SELECT
...
\unrestrict 5HQeBWVni2eiYWFPSei7Y4oCAzJEdKntzPtzZziNAvebF9O6RTNLk7H6HcKiWCv
