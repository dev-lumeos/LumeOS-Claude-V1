...
OUT = Path(r"D:\GitHub\LumeOS-Claude-V1\backup\c281\probe-direkt.out")
...
queries = {
    ...
    """,
    "magnesium_parent": """
      select s.name_en, d.dose_unit, d.frequency_en, d.duration_studied_en, d.sources->'child_names'
