...
**Erzeugt aus dem Frontmatter. Nie von Hand pflegen.**
`node tools/punkte-index.mjs --schreiben`
...
| `C-308` | befund | mittel | [keine Produktdaten fuer den deutschen Markt](todos/medical-c-0308-keine-produktdaten-fuer-den-deutschen-markt.md) | offen | — | — |
...
| `C-366` | befund | mittel | [`food_tags` hat keinen Pflegeweg](erledigt/nutrition-c-0366-food-tags-hat-keinen-pflegeweg.md) | erledigt | — | C-410 |
...
| `C-373` | befund | mittel | [der Lebenszyklus wird gespeichert und nie ausgefuehrt](erledigt/nutrition-c-0373-der-lebenszyklus-wird-gespeichert-und-nie-ausgefuehrt.md) | erledigt | — | C-377 |
...
| `G-126` | befund | mittel | [Drei Reste aus G-122](erledigt/nutrition-g-0126-drei-reste-aus-g-122.md) | erledigt | — | C-210, C-211, C-212 |
...
| `G-234` | befund | niedrig | [`IntoleranceSelector` und `ReligiousDietarySelector` nur als Onboarding-Components definiert](erledigt/nutrition-g-0234-intoleranceselector-und-religiousdietaryselector-nur-als-o.md) | erledigt | — | — |
...
| `G-238` | befund | niedrig | [`Plan.source = 'buddy'` in SPEC_10 ohne UI-Trigger](erledigt/nutrition-g-0238-plan-source-buddy-in-spec-10-ohne-ui-trigger.md) | erledigt | — | — |
...
| `G-302` | befund | niedrig | [die Zielzeile bricht um](erledigt/nutrition-g-0302-die-zielzeile-bricht-um.md) | erledigt | — | — |
...
| `G-305` | befund | hoch | [vier Sackgassen in Plaenen und Planner](erledigt/nutrition-g-0305-vier-sackgassen-in-plaenen-und-planner.md) | erledigt | — | — |
...
| `G-314` | feature | mittel | [die Vorschau fuer nicht-aktive Plaene](erledigt/nutrition-g-0314-die-vorschau-fuer-nicht-aktive-plaene.md) | erledigt | — | — |
...
| `G-338` | entscheidung | mittel | [eine freie Mahlzeit hat keinen Namen](erledigt/nutrition-g-0338-eine-freie-mahlzeit-hat-keinen-namen.md) | erledigt | — | — |
...
| `C-260` | blocker | hoch | [Die Arbeitsberichte sind nicht in die Daten zurueckgeflossen](erledigt/supplements-c-0260-die-arbeitsberichte-sind-nicht-in-die-daten-zurueckgeflossen.md) | erledigt | — | C-261, C-365 |
...
| `C-316` | feature | mittel | [NAC steht im Katalog ohne deutschen Namen](erledigt/supplements-c-0316-nac-steht-im-katalog-ohne-deutschen-namen.md) | erledigt | — | C-352 |
...
| `C-86` | feature | mittel | [8 mehrdeutige Uebungen und 1 ohne DB-Namen](todos/training-c-0086-8-mehrdeutige-uebungen-und-1-ohne-db-namen.md) | offen | — | — |
| `C-87` | befund | mittel | [`exercises_select` war aus der Datenbank verschwunden](todos/training-c-0087-exercises-select-war-aus-der-datenbank-verschwunden.md) | offen | — | — |
...
| `C-268` | feature | mittel | [Beim Einladen gibt es keine Namensaufloesung](erledigt/coach-c-0268-beim-einladen-gibt-es-keine-namensaufloesung.md) | erledigt | — | C-428 |
...
| `C-428` | befund | mittel | [das Onboarding fuer Unregistrierte](erledigt/coach-c-0428-onboarding-fuer-unregistrierte.md) | erledigt | — | C-438 |
...
| `G-391` | feature | hoch | [das Coach-Grundgeruest aus den Vorlagen](erledigt/coach-g-0391-das-grundgeruest-aus-den-vorlagen.md) | erledigt | — | G-397 |
...
| `A-40` | befund | mittel | [Nachweise ohne Stichtag belegen nichts](todos/quer-a-0040-nachweise-ohne-stichtag-belegen-nichts.md) | offen | — | — |
| `A-42` | befund | mittel | [`schuss.mjs` und die Git-Bash-Pfadumwandlung](todos/quer-a-0042-schuss-mjs-und-die-git-bash-pfadumwandlung.md) | offen | — | — |
| `A-44` | messung | mittel | [Eine Nummernpruefung fuers Gate](todos/quer-a-0044-eine-nummernpruefung-fuers-gate.md) | offen | — | — |
| `A-48` | feature | mittel | [Der Index wird vor dem `git add` nicht geleert](todos/quer-a-0048-der-index-wird-vor-dem-git-add-nicht-geleert.md) | offen | — | — |
| `A-51` | befund | mittel | [Zahlen in `TODO.md` brauchen einen Stichtag](todos/quer-a-0051-zahlen-in-todo-md-brauchen-einen-stichtag.md) | offen | — | — |
| `A-52` | feature | hoch | [die 244 offenen Punkte in das neue Modell ueberfuehren](erledigt/quer-a-0052-punkte-migration.md) | erledigt | — | A-54 |
...
| `F-04` | befund | mittel | [Sitzungsextraktor](todos/quer-f-0004-sitzungsextraktor.md) | offen | — | C-114, C-115, C-71 |
| `F-05` | befund | mittel | [Suche über das Extrahierte](todos/quer-f-0005-suche-uber-das-extrahierte.md) | offen | — | — |
| `F-06` | messung | mittel | [Backend erst nach zwei Wochen Gebrauch wählen](todos/quer-f-0006-backend-erst-nach-zwei-wochen-gebrauch-wahlen.md) | offen | — | — |
| `F-07` | befund | mittel | [Berechtigungen](todos/quer-f-0007-berechtigungen.md) | offen | — | C-155, G-151 |
