  ...
  return (
    <>
      ...
      <Tabs items={[
        ...
        { id: "memlayers", label: "Memory layers" },
      ...
      {tab === "config"    && window.AIConfigView && <window.AIConfigView/>}
      {tab === "memlayers" && window.AIMemoryLayersView && <window.AIMemoryLayersView/>}
      {tab === "clone"     && window.AICloneView && <window.AICloneView/>}
      {tab === "widget"    && window.AIWidgetView && <window.AIWidgetView/>}
      {tab === "state"     && window.AIStateView && <window.AIStateView/>}
      {tab === "events"    && window.AIEventsView && <window.AIEventsView/>}
      {tab === "decisions" && window.AIDecisionsView && <window.AIDecisionsView/>}
      {tab === "intervene" && window.AIInterventionView && <window.AIInterventionView/>}
      {tab === "bss"       && window.AIBSSView && <window.AIBSSView/>}
      {tab === "prefs"     && window.AIPreferencesView && <window.AIPreferencesView/>}
      {tab === "routing"   && window.AIRoutingView && <window.AIRoutingView/>}
      {tab === "butler"    && window.AIButlerView && <window.AIButlerView/>}
      {tab === "watcher"   && window.AIWatcherView && <window.AIWatcherView/>}
      {tab === "journey"   && window.AIJourneyView && <window.AIJourneyView/>}
      {tab === "policy"    && window.AIPolicyView && <window.AIPolicyView/>}
      {tab === "signature" && window.AISignatureView && <window.AISignatureView/>}
      {tab === "contract"  && window.AIContractView && <window.AIContractView/>}
      {tab === "tiers"     && window.AITiersView && <window.AITiersView/>}
