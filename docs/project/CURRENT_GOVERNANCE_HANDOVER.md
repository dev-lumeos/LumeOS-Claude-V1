...
- The next database boundary is no longer local schema proof. The next boundary is an explicit DEV promotion decision for this exact schema-only slice. Seed payload, RDA updates, BLS import, and any broader Nutrition DB work remain blocked.
