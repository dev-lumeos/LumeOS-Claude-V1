...
- Codex Worker Bridge for constrained non-interactive `codex exec` prompt construction and future `senior-coding-agent` worker invocation. Dispatcher auto-run remains disabled by default.
