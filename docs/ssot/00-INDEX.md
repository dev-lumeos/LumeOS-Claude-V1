...
| `109-medical-anbindung.md` | **Medical liest echt** — Befundtabelle und Katalogsuche verlieren die Marke, 21 bleiben. Der Doppelbereich live belegt (Glucose 102 · Labor 70–99 · Optimal 70–85), der unbekannte Marker wird gezeigt statt uebersprungen. **Der Bereichsbestand ist duenner als seine Zeilenzahl:** von 464 Zeilen tragen 54 Zahlen — und genau die schliesst die Lesefunktion aus. Suche 353–382 ms ueber 11.676 Zeilen. **Und: `tom.seed@example.com` hat kein Passwort** — alle Testdaten haengen an einem Konto, an dem sich niemand anmelden kann |
