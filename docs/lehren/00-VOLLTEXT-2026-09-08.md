# CLAUDE.md, Volltext vor der Aufteilung

**2026-09-08, 1817 Zeilen.** `[read]` **Aufgeteilt nach `docs/lehren/`, weil die Datei zu lang war, um sie nachzuschlagen.**

`[cmd]` **Der Anlass: der Orchestrator nannte einen falschen Serverbefehl, obwohl der richtige seit dem 22.08. in Zeile 1307 stand.**
