// Reine Rollenprüfung für die Oberfläche (C.3, 2026-08-06).
// KEIN I/O — die Sitzung holt admin-session.ts. Diese Datei enthält nur
// die Regel, damit sie testbar ist und an genau einer Stelle steht.
//
