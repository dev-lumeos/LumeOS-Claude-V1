-- C-313 Weg 2: `lab_above` wertet die zwei auswertbaren High-Regeln aus.
-- Die verbleibenden High-Operatoren bleiben bewusst unsupported, solange
-- ihre Eingabemodelle nicht existieren.
...
COMMENT ON FUNCTION supplements.rule_operator_supported(TEXT, TEXT, TEXT, TEXT) IS
  'C-313b/C-313 Weg 2: Zentraler Operatorvertrag fuer rule_assessment und den Gate-Waechter.';
COMMENT ON FUNCTION supplements.rule_assessment(UUID, DATE) IS
  'C-133/C-313b/C-313 Weg 2: Nutzerbezogene Regelauswertung mit fulfilled, not_fulfilled, missing_input oder unsupported_operator.';
