-- =============================================================
-- 057 — Suchprotokoll (C-18)
-- Datum: 2026-08-15
-- Zweck: nutrition.search_events anlegen, inkl. Rechten, RLS und
--        Auswertungsfunktion.
--
-- Datenschutzentscheidung:
--   Gespeichert wird eine Sitzungskennung, KEINE Nutzerkennung. Der
--   Verlauf innerhalb einer Sitzung ist auswertbar; ein Kontobezug ist
--   für die Suchqualität nicht nötig und würde die Zeile unnötig
--   personenbezogen machen.
--
-- Architekturentscheidung:
--   Das Mitschreiben liegt NICHT in nutrition.food_search. Die Suche ist
--   heiss; die Anwendung ruft nach dem Such-RPC einen separaten INSERT.
--   Damit bleibt die Lesefunktion unverändert schnell und ein Logging-
--   Fehler macht die Suche nicht unbenutzbar.
-- =============================================================
