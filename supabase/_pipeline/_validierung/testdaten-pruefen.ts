...
if (MODE === 'clean') {
  ...
  if (mealPlans !== 4) errors.push(`meal_plans: ${mealPlans}, erwartet 4`)
  if (mealPlanWeeks !== 6) errors.push(`meal_plan_weeks: ${mealPlanWeeks}, erwartet 6`)
  if (mealPlanDays !== 42) errors.push(`meal_plan_days: ${mealPlanDays}, erwartet 42`)
  if (mealPlanEntries !== 140) errors.push(`meal_plan_entries: ${mealPlanEntries}, erwartet 140`)
