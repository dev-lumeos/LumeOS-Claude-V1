-- C-362/E-20: Zweckgebundene Einwilligungsereignisse. Dieses Protokoll
-- ist weder OAuth-Anmeldung noch die Aenderungshistorie von Berechtigungen.
-- Es speichert nur die Tatsache der Erteilung bzw. des Widerrufs; ein
-- Dialog oder anderer Schreibweg wird hier bewusst nicht gebaut.
