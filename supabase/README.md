...
| 327 | `13_supplements/327_substance_group_membership.sql` | C-327: getrennte fachliche Substanzgruppen und auswertbare Gruppenoperatoren in `rule_assessment` | RLS-Katalogtabelle; Produktgruppen bleiben unberuehrt |
| 327a | `13_supplements/327a_chelation_mineral_membership.sql` | C-327: chelatierende Mineralstoffe aus der expliziten Kimi-Regel ableiten | 8 Mitgliedschaften fuer `grp_chelating_minerals` |
...
| 059d | `05_user_tabellen/059d_reference_assessment_window_flags.sql` | C-348: `reference_assessment_window_flags()` verdichtet die vorhandenen Tagesbewertungen zu Flag-Kandidaten; `daily_assessments` wird nicht uebertragen | 1 Funktion |
