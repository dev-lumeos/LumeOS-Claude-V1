...
export type { SidebarGruppe, SidebarEintrag } from './shell/sidebar'
...
// G-402: die Trennlinie -- EINE Fassung fuer alle Anwendungen.
export { ReferenzTrenner } from './referenz-trenner'
