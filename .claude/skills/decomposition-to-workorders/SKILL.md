...
2. Lies: `system/agent-registry/agent_registry_v2.md`
3. Lies: `system/model-tiers/model_tiers_v2.md`
4. Lies: `system/policies/gsd-v2/gsd_v2.md`
...
2. Weise Agent zu (via Layer → Agent Mapping aus agent_registry_v2)
